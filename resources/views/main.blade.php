    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          {{-- <a href="{{ url('Catagory' )}}" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Catagory</span></a> --}}
          <a href="{{ url('newsind' )}}" class="nav-link has-dropdown"><i class="fas fa-video"></i>  <span>Data Berita</span></a>
        </aside> 
      </div>
